...
export function OpenStatusPill() {
  ...
  return (
    ...
    >
      ...
      {/* Each part is click-to-edit in the admin; the Open/Closed word shown depends on the current time. */}
      <span>
        {open === null ? null : (
          <>
            <T p={open ? "site.header.openLabel" : "site.header.closedLabel"} />
            {" · "}
          </>
        )}
        <T p="site.business.hoursShort" />
      </span>
