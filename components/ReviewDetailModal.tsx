...
export function ReviewDetailModal({
  ...
  if (review.beforeSrc) {
    lightboxItems.push({
      ...
      subtitle: `Swirl marks, scratches, and oxidation prior to correction (${review.author}, ${review.city})`,
      badge: "Before",
    });
  }
  if (review.afterSrc) {
    lightboxItems.push({
      ...
      title: `${review.vehicle} · Flawless Ceramic Gloss`,
      subtitle: `Mirror reflection and hydrophobic ceramic coating completed (${review.author}, ${review.city})`,
      badge: "After",
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="no-scrollbar overflow-y-auto p-5 sm:p-6">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 flex flex-wrap items-center gap-2 text-xs text-zinc-400">
                ...
                <span className="inline-flex items-center gap-1">
                  ...
                  Verified on-site booking
                </span>
              </div>
            </div>
            <div className="flex flex-col items-end">
              <Stars rating={review.rating} className="size-4" />
              <span className="mt-1 text-[11px] font-semibold text-emerald-400">5.0 / 5.0</span>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-3">
              ...
              <dd className="mt-1 truncate text-xs font-semibold text-zinc-100 sm:text-sm">{review.vehicle}</dd>
            </div>
            <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-3">
              <dt className="flex items-center gap-1 text-[10px] font-semibold tracking-wider text-zinc-400 uppercase">
              ...
              <dd className="mt-1 truncate text-xs font-semibold text-zinc-100 sm:text-sm">
                {serviceName || "Signature Ceramic Detail"}
              </dd>
            </div>
          </div>
            ...
            <div className="mt-5">
              <div className="flex items-center justify-between">
                <p className="text-xs font-semibold tracking-wider text-zinc-400 uppercase">
                  Service Documentation (2 photos)
                </p>
              ...
              >
                ...
                >
                  ...
                  {activeTab === "after" ? "After · Ceramic Coating" : "Before · Swirls & Film"}
                </span>
                ...
                <div className="absolute inset-x-3 bottom-3 flex items-center justify-between rounded-xl border border-white/10 bg-black/60 px-3 py-2 text-xs font-medium text-white backdrop-blur-md transition-opacity group-hover:bg-black/80">
                  ...
                  <span className="text-[11px] text-zinc-400">Retina Zoom</span>
                </div>
              </div>
              ...
              <div className="mt-2.5 grid grid-cols-2 gap-2">
                {review.beforeSrc && (
                  ...
                  >
                    <div className="relative size-12 shrink-0 overflow-hidden rounded-lg">
                      <Image src={review.beforeSrc} alt="Before" fill className="object-cover" />
                    </div>
                    <div className="min-w-0 flex-1 text-xs">
                      <p className="font-semibold text-zinc-200">Before Photo</p>
                      <p className="truncate text-[11px] text-zinc-400">Swirls & scratches</p>
                    </div>
                  </button>
                )}
                ...
                {review.afterSrc && (
                  ...
                  >
                    <div className="relative size-12 shrink-0 overflow-hidden rounded-lg">
                      <Image src={review.afterSrc} alt="After" fill className="object-cover" />
                    </div>
                    <div className="min-w-0 flex-1 text-xs">
                      <p className="font-semibold text-emerald-300">After Photo</p>
                      <p className="truncate text-[11px] text-zinc-400">Deep mirror finish</p>
                    </div>
                  </button>
                )}
              </div>
        ...
        <div className="border-t border-zinc-800/80 bg-zinc-950/80 p-4 sm:px-6">
          ...
          >
            Book {serviceName || "this treatment"}
